...
class Test_computeSolution( unittest.TestCase ):
    # def test_cubic_polynomial_target( self ): #passes with +0 qp
    #     # print( "POLY TEST" )
    ...
    # def test_sin_target( self ): #passes with +3 qp
    #     # print( "SIN TEST" )
    ...
    # def test_erfc_target( self ): #passes with +5 qp
    #     # print( "ERFC TEST" )
    ...
    def test_exptx_target( self ): #passes with +6 qp
        # print( "EXPT TEST" )
